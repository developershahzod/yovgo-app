import svgPaths from "./svg-yp93cink1u";
      ...
      <div className="absolute left-[calc(50%+0.5px)] size-[120px] top-1/2 translate-x-[-50%] translate-y-[-50%]" data-name="Blur">
        <div className="absolute inset-[-20%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 168 168">
            <g filter="url(#filter0_f_7_1206)" id="Blur">
              <circle cx="84" cy="84" fill="var(--fill-0, white)" fillOpacity="0.4" r="60" />
            </g>
            <defs>
              <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="168" id="filter0_f_7_1206" width="168" x="0" y="0">
                <feFlood floodOpacity="0" result="BackgroundImageFix" />
                <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
                <feGaussianBlur result="effect1_foregroundBlur_7_1206" stdDeviation="12" />
              </filter>
            </defs>
          </svg>
        </div>
  ...
  return (
    <div className="bg-[rgba(0,191,254,0.32)] content-stretch flex gap-[10px] items-center p-[20px] relative rounded-[100px] shrink-0" data-name="Container">
      <div className="absolute left-[calc(50%+0.5px)] size-[120px] top-1/2 translate-x-[-50%] translate-y-[-50%]" data-name="Blur">
        <div className="absolute inset-[-20%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 168 168">
            <g filter="url(#filter0_f_7_1192)" id="Blur">
              <circle cx="84" cy="84" fill="var(--fill-0, #00BFFE)" fillOpacity="0.4" r="60" />
            </g>
            <defs>
              <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="168" id="filter0_f_7_1192" width="168" x="0" y="0">
                <feFlood floodOpacity="0" result="BackgroundImageFix" />
                <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
                <feGaussianBlur result="effect1_foregroundBlur_7_1192" stdDeviation="12" />
              </filter>
            </defs>
          </svg>
        </div>
  ...
  return (
    <div className="absolute inset-[-0.02%]" data-name="Group">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40.0167 40.0167">
        <g id="Group">
          <path d="M20.01 15.0062V13.3388" id="Path" stroke="var(--stroke-0, #FFEEEA)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M20.01 25.0103V26.6777" id="Path_2" stroke="var(--stroke-0, #FFEEEA)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d={svgPaths.p3382a00} id="Path_3" stroke="var(--stroke-0, #FFEEEA)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d={svgPaths.p2a26e180} id="a" stroke="var(--stroke-0, #FFEEEA)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d={svgPaths.p2a26e180} id="a-2" stroke="var(--stroke-0, #FFEEEA)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <g id="Rectangle" />
        </g>
      </svg>
    </div>
  ...
  return (
    <div className="relative shrink-0 size-[24px]" data-name="chevron">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="chevron">
          <path d="M16 14L12 10L8 14" id="Path" stroke="var(--stroke-0, #0A0C13)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function Check() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="check">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="check">
          <path d="M17 9.00002L11 15L8 12" id="Vector" stroke="var(--stroke-0, #0A0C13)" strokeLinecap="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function Group3() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="group">
      <div className="css-g0mm18 flex flex-col font-['Mulish:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#0a0c13] text-[15px]">
        <p className="css-ew64yg leading-[1.2]">{`O'zbekcha`}</p>
      </div>
    </div>
  );
}
...
function Suffix1() {
  return <div className="shrink-0 size-[24px]" data-name="suffix" />;
}
...
function LangSwitcher() {
  return (
    <div className="absolute backdrop-blur-[10px] bg-[rgba(255,255,255,0.95)] content-stretch flex flex-col items-start left-[163px] overflow-clip px-[16px] py-[8px] rounded-[22px] shadow-[0px_4px_45px_0px_rgba(0,0,0,0.25)] top-[88px] w-[196px]" data-name="lang-switcher">
      <MenuItem />
      <MenuItem1 />
    </div>
  );
...
export default function OnboardingLangSwitch() {
  return (
    <div className="bg-white relative size-full" data-name="Onboarding_lang switch">
      <Statusbar />
      <Navbar />
      <ButtonMin />
      <Cards />
