import svgPaths from "./svg-ndg1wdyuz9";
import imgImage12 from "figma:asset/e2d4f20f6f21ca29965bce155483363d13319d23.png";
    ...
    <div className="absolute contents left-1/2 top-1/2 translate-x-[-50%] translate-y-[-50%]" data-name="BG">
      <div className="absolute h-[180px] left-0 top-1/2 translate-y-[-50%] w-[343px]" data-name="image 12">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[134.29%] left-0 max-w-none top-[-17.33%] w-[123.33%]" src={imgImage12} />
        </div>
      </div>
...
function Text() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start justify-end leading-[1.2] relative shrink-0 text-white w-[303px]" data-name="Text">
      <p className="css-4hzbpn font-['Mulish:Black',sans-serif] font-black relative shrink-0 text-[16px] w-[269px]">365 kunlik</p>
      <p className="css-ew64yg font-['Mulish:Regular',sans-serif] font-normal relative shrink-0 text-[12px]">Tugaydi: Yanvar 15, 2027</p>
    </div>
  );
}
...
function Crown() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="crown">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="crown">
          <path clipRule="evenodd" d={svgPaths.p2947a180} fill="var(--fill-0, #0A0C13)" fillRule="evenodd" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Group1() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="group">
      <div className="css-g0mm18 flex flex-col font-['Mulish:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#0a0c13] text-[16px]">
        <p className="css-ew64yg leading-[1.2]">Premium avtomoykalar</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="absolute h-[12px] right-[13px] top-[calc(50%+1px)] translate-y-[-50%] w-[67.272px]" data-name="Pin Right">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 67.2724 12">
        <g clipPath="url(#clip0_6_10898)" id="Pin Right">
...
export default function Subscription() {
  return (
    <div className="overflow-clip relative rounded-[40px] size-full" data-name="Subscription 365">
      <MProfileSigned />
      <Navigation />
    </div>
  );
