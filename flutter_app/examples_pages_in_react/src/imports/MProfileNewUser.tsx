import svgPaths from "./svg-1kdoc21r9e";
  ...
  return (
    <div className="relative shrink-0 size-[80px]" data-name="avatar">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 80 80">
        <g id="avatar">
          <path clipRule="evenodd" d={svgPaths.p379c0900} fill="var(--fill-0, #F0F4F9)" fillRule="evenodd" id="stroke" />
          <g id="avatar-types">
            <circle cx="40.2174" cy="40.2174" fill="url(#paint0_linear_6_6781)" id="bound" r="35" />
            <g id="placeholder">
              <path d={svgPaths.p13e60400} fill="url(#paint1_linear_6_6781)" id="Intersect" />
              <g id="Intersect_2">
                <path d={svgPaths.p283834f2} fill="url(#paint2_radial_6_6781)" fillOpacity="0.7" style={{ mixBlendMode: "overlay" }} />
              </g>
            </g>
          </g>
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_6_6781" x1="40.2174" x2="40.2174" y1="5.21739" y2="75.2174">
            <stop stopColor="#F1F6FD" />
            <stop offset="1" stopColor="#E0E3E8" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_6_6781" x1="39.9993" x2="39.9993" y1="19.1309" y2="74.7828">
            <stop stopColor="#CFD6E6" />
            <stop offset="1" stopColor="#AEB7C8" />
          </linearGradient>
          <radialGradient cx="0" cy="0" gradientTransform="translate(39.8742 47.0511) rotate(90) scale(21.3482 35.2509)" gradientUnits="userSpaceOnUse" id="paint2_radial_6_6781" r="1">
            <stop />
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start justify-center min-h-px min-w-px relative" data-name="name">
      <div className="flex flex-col font-['Mulish:Bold',sans-serif] font-bold justify-center leading-[0] min-w-full relative shrink-0 text-[#0a0c13] text-[18px] w-[min-content]">
        <p className="css-4hzbpn leading-[1.2]">Tizimga kiring</p>
      </div>
      <p className="css-4hzbpn font-['Mulish:Regular',sans-serif] font-normal leading-[1.2] min-w-full relative shrink-0 text-[#646d79] text-[14px] w-[min-content]">Ilovaning barcha qulayliklaridan foydalanish uchun ro’yxatdan o’ting</p>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[20px]" data-name="login">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="login">
          <path d="M8.33542 10L12.5038 14.1684" id="Path" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          <path d={svgPaths.p31445a80} id="Path_2" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          <path d={svgPaths.p6e6d4c0} id="Path_3" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          <path d={svgPaths.p22241a00} id="Path_4" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
...
function ButtonMin() {
  return (
    <div className="backdrop-blur-[10px] bg-[#03142a] content-stretch flex gap-[6px] h-[50px] items-center justify-center p-[16px] relative rounded-[16px] shadow-[0px_2px_20px_0px_rgba(0,0,0,0.25)] shrink-0 w-[343px]" data-name="button-min">
      <div className="css-g0mm18 flex flex-col font-['Mulish:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[15px] text-white">
        <p className="css-ew64yg leading-[1.2]">Tizimga kirish</p>
      </div>
      <Login />
    </div>
  );
...
function TopBlock() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[16px] items-start pb-[16px] px-[16px] relative rounded-bl-[22px] rounded-br-[22px] shrink-0 w-[375px]" data-name="Top block">
      <Statusbar />
      <Info />
      <ButtonMin />
    </div>
...
export default function MProfileNewUser() {
  return (
    <div className="overflow-clip relative rounded-[40px] size-full" data-name="m_profile-new-user">
      <MProfileSigned />
      <Navigation />
    </div>
  );
