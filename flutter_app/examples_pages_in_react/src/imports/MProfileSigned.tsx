import svgPaths from "./svg-tvnwamdn4r";
    ...
    <div className="h-[44px] overflow-clip relative shrink-0 w-full" data-name="statusbar">
      ...
      <div className="absolute h-[10.966px] right-[44.03px] top-[calc(50%+0.81px)] translate-y-[-50%] w-[15.272px]" data-name="Wifi">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.2725 10.9661">
          <path d={svgPaths.p19367a80} fill="var(--fill-0, black)" id="Wifi" />
        </svg>
      </div>
      <div className="absolute h-[10.667px] right-[64.33px] top-[calc(50%+1px)] translate-y-[-50%] w-[17px]" data-name="Mobile Signal">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17 10.667">
          <path d={svgPaths.p2abaf680} fill="var(--fill-0, black)" id="Mobile Signal" />
        </svg>
      </div>
      <TimeStyle />
    </div>
    ...
    <div className="relative shrink-0 size-[80px]" data-name="avatar">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 80 80">
        <g id="avatar">
          ...
          <g id="avatar-types">
            <circle cx="40.2174" cy="40.2174" fill="url(#paint0_linear_6_6545)" id="bound" r="35" />
            <g id="placeholder">
              <path d={svgPaths.p38174300} fill="url(#paint1_linear_6_6545)" id="Intersect" />
              <g id="Intersect_2">
                <path d={svgPaths.p283834f2} fill="url(#paint2_radial_6_6545)" fillOpacity="0.7" style={{ mixBlendMode: "overlay" }} />
              </g>
            </g>
          </g>
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_6_6545" x1="40.2174" x2="40.2174" y1="5.21739" y2="75.2174">
            <stop stopColor="#F1F6FD" />
            <stop offset="1" stopColor="#E0E3E8" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_6_6545" x1="39.9993" x2="39.9993" y1="19.1309" y2="74.7828">
            <stop stopColor="#CFD6E6" />
            <stop offset="1" stopColor="#AEB7C8" />
          </linearGradient>
          <radialGradient cx="0" cy="0" gradientTransform="translate(39.8742 47.0511) rotate(90) scale(21.3482 35.2509)" gradientUnits="userSpaceOnUse" id="paint2_radial_6_6545" r="1">
            <stop />
  ...
  return (
    <div className="relative shrink-0 size-[20px]" data-name="car wash">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_6_6578)" id="car wash">
          <path d={svgPaths.p13ea9300} fill="var(--fill-0, #0A0C13)" id="Exclude" />
        </g>
        <defs>
          <clipPath id="clip0_6_6578">
  ...
  return (
    <div className="content-stretch flex flex-col gap-[2px] items-start justify-center leading-[0] relative shrink-0" data-name="text">
      <div className="css-g0mm18 flex flex-col font-['Mulish:Black',sans-serif] font-black justify-center relative shrink-0 text-[#0a0c13] text-[15px]">
        <p className="css-ew64yg leading-[1.2]">0</p>
      </div>
...
function Trand() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="trand">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_6_6679)" id="trand">
          <path d={svgPaths.p1fb9df80} fill="var(--fill-0, #0A0C13)" id="Exclude" />
        </g>
        <defs>
          <clipPath id="clip0_6_6679">
            <rect fill="white" height="20" width="20" />
          </clipPath>
        </defs>
      </svg>
...
function DollarSign() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="dollar sign">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_6_6602)" id="dollar sign">
          <path d={svgPaths.p2a51f5c0} fill="var(--fill-0, #0A0C13)" id="Exclude" />
        </g>
        <defs>
          <clipPath id="clip0_6_6602">
            <rect fill="white" height="20" width="20" />
          </clipPath>
        </defs>
      </svg>
...
export default function MProfileSigned() {
  return (
    <div className="overflow-clip relative rounded-[40px] size-full" data-name="m_profile-signed">
      <MProfileSigned1 />
      <Navigation />
    </div>
  );
