import svgPaths from "./svg-x5jpz1x3zu";
...
function Badges() {
  return (
    <div className="absolute bg-white bottom-[20px] content-stretch flex flex-col items-start leading-[0] px-[8px] py-[4px] right-[20px] rounded-[12px] text-[#0a0c13] w-[54px]" data-name="Badges">
    ...
    <div className="absolute contents left-1/2 top-1/2 translate-x-[-50%] translate-y-[-50%]" data-name="BG">
      <div className="absolute h-[180px] left-0 top-1/2 translate-y-[-50%] w-[343px]" data-name="image 12">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[171.04%] left-0 max-w-none top-[-32.16%] w-[138.12%]" src={imgImage12} />
        </div>
      </div>
...
function Text() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start justify-end leading-[1.2] relative shrink-0 text-white w-[239px]" data-name="Text">
      <p className="css-4hzbpn font-['Mulish:Black',sans-serif] font-black relative shrink-0 text-[16px] w-[269px]">30 kunlik obuna</p>
...
function Frame5() {
  return (
    <div className="content-stretch flex items-start relative shrink-0">
      <p className="css-ew64yg font-['Mulish:Black',sans-serif] font-black leading-[1.2] relative shrink-0 text-[#0a0c13] text-[16px]">8/12</p>
    </div>
  );
}
...
function Container2() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start justify-center relative shrink-0" data-name="Container">
      <p className="css-ew64yg font-['Mulish:Regular',sans-serif] font-normal leading-[1.2] relative shrink-0 text-[#0a0c13] text-[12px]">Shu oy tashriflari</p>
      <Frame5 />
    </div>
  );
}
  ...
  return (
    <div className="absolute h-[12px] right-[13px] top-[calc(50%+1px)] translate-y-[-50%] w-[67.272px]" data-name="Pin Right">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 67.2724 12">
        <g clipPath="url(#clip0_6_10764)" id="Pin Right">
...
export default function Subscription() {
  return (
    <div className="overflow-clip relative rounded-[40px] size-full" data-name="Subscription 30">
      <MProfileSigned />
      <Navigation />
    </div>
  );
