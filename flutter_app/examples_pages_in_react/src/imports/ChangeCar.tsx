import svgPaths from "./svg-435htrjoqj";
import imgChangeCar from "figma:asset/e84decbff63abebf3913926a9d0edbf52a56e848.png";
import imgChangeCar1 from "figma:asset/bbee97e951036325dfe85abc45041b92fe3aadfa.png";
  ...
  return (
    <div className="absolute h-[12px] right-[13px] top-[calc(50%+1px)] translate-y-[-50%] w-[67.272px]" data-name="Pin Right">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 67.2725 12">
        <g clipPath="url(#clip0_1_10259)" id="Pin Right">
  ...
  return (
    <div className="absolute inset-[-0.02%]" data-name="Group">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24.01 24.01">
        <g id="Group">
          <g id="Path"></g>
          <path d="M8.25344 11.5048H6.2526" id="Path_2" stroke="var(--stroke-0, #00BFFE)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          <path d={svgPaths.p3e1b3c80} id="Path_3" stroke="var(--stroke-0, #00BFFE)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          <path d={svgPaths.pdeb9200} id="Path_4" stroke="var(--stroke-0, #00BFFE)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          <path d={svgPaths.p13b28c0} id="Path_5" stroke="var(--stroke-0, #00BFFE)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          <path d={svgPaths.p28204440} id="Path_6" stroke="var(--stroke-0, #00BFFE)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          <path d="M14.7561 11.5048H16.757" id="Path_7" stroke="var(--stroke-0, #00BFFE)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          <path clipRule="evenodd" d={svgPaths.p33d79500} fillRule="evenodd" id="Path_8" stroke="var(--stroke-0, #00BFFE)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
...
function CarSelection1() {
  return (
    <div className="bg-white relative rounded-[20px] shrink-0 w-full" data-name="Car selection">
      <div aria-hidden="true" className="absolute border border-[#00bffe] border-solid inset-0 pointer-events-none rounded-[20px]" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center p-[12px] relative w-full">
          <Icon1 />
          <Container2 />
...
function Container3() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[8px] items-start justify-center min-h-px min-w-px relative" data-name="Container">
      <div className="flex flex-col font-['Mulish:Bold',sans-serif] font-bold justify-center leading-[0] min-w-full relative shrink-0 text-[#0a0c13] text-[16px] w-[min-content]">
        <p className="css-4hzbpn leading-[1.2]">Tracker 2 redline</p>
      </div>
      <Tags2 />
    </div>
  );
...
function Number3() {
  return (
    <div className="content-stretch flex items-center justify-center px-[4px] py-[2px] relative shrink-0" data-name="Number">
      <div className="css-g0mm18 flex flex-col font-['Mulish:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#0a0c13] text-[10px]">
        <p className="css-ew64yg leading-[1.2]">O 333 OO</p>
      </div>
    </div>
  );
}

function CarPlateNumber3() {
  return (
    <div className="bg-white content-stretch flex items-center relative rounded-[4px] shrink-0" data-name="Car plate number">
      <div aria-hidden="true" className="absolute border border-[#d9dde3] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <Region3 />
...
function Container4() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[8px] items-start justify-center min-h-px min-w-px relative" data-name="Container">
      <div className="flex flex-col font-['Mulish:Bold',sans-serif] font-bold justify-center leading-[0] min-w-full relative shrink-0 text-[#0a0c13] text-[16px] w-[min-content]">
        <p className="css-4hzbpn leading-[1.2]">Malibu 2</p>
      </div>
      <Tags3 />
    </div>
  );
...
function ButtonMin() {
  return (
    <div className="backdrop-blur-[10px] bg-[#03142a] h-[50px] relative rounded-[16px] shadow-[0px_2px_20px_0px_rgba(0,0,0,0.25)] shrink-0 w-full" data-name="button-min">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex gap-[6px] items-center justify-center p-[16px] relative size-full">
          <div className="css-g0mm18 flex flex-col font-['Mulish:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[15px] text-white">
            <p className="css-ew64yg leading-[1.2]">Saqlash</p>
          </div>
        </div>
      </div>
    </div>
...
function List() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start px-[16px] py-[12px] relative shrink-0 w-[375px]" data-name="list">
      <CarSelection1 />
      <CarSelection2 />
      <CarSelection3 />
      <ButtonMin />
...
export default function ChangeCar() {
  return (
    <div className="overflow-clip relative rounded-[40px] size-full" data-name="Change car">
      <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[40px]">
        <div className="absolute inset-0 overflow-hidden rounded-[40px]">
          <img alt="" className="absolute h-full left-[-31.2%] max-w-none top-0 w-[162.4%]" src={imgChangeCar} />
        </div>
        <div className="absolute inset-0 overflow-hidden rounded-[40px]">
          <img alt="" className="absolute h-full left-[-147.68%] max-w-none top-[-0.04%] w-[324.8%]" src={imgChangeCar1} />
        </div>
      </div>
      <IOsStatusBar />
      ...
      <div className="absolute bg-[rgba(0,0,0,0.6)] h-[812px] left-1/2 top-1/2 translate-x-[-50%] translate-y-[-50%] w-[375px]" data-name="backdrop" />
      <SearchBar />
